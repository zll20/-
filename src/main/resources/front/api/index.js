...
export const wxlogin = (tableName, data) => {
	return http.request({
		url: `${tableName}/wx/login`,
		method: 'post',
		data:data
	})
}
export const wxbind = (tableName,data) => {
	return http.request({
		url: `${tableName}/wx/bind`,
		method: 'post',
		data:data
	})
}
 ...
 * 登陆
 */
export const wxunbind = (tableName,data) => {
	return http.request({
		url: `${tableName}/wx/unbind`,
		method: 'post',
		data:data
	})
}
 ...
 * 查询
 */
export const query = (tableName, data) => {
	return http.request({
		url: `${tableName}/query`,
		method: 'GET',
		data
 ...
 * 百度识别（文字，动物，植物，菜品）
 */
export const baiduIdentify2 = (type,data) => {
	return http.request({
		url: `baidu/${type}`,
		method: 'GET',
		data
 ...
 * 百度AI
 */
export const baiduIdentify3 = (type,data) => {
	return http.request({
		url: `baidu/${type}`,
		method: 'POST',
		data
...
export const baiduIdentify4 = (tableName,type,data) => {
	return http.request({
		url: `${tableName}/baidu/${type}`,
		method: 'GET',
		data
	});
}
...
// 论坛接口
export const allPublicForm = (data) => {
	return http.request({
		url: `forum/flist?parentid=0&isdone=开放&sort=istop,toptime&order=desc,desc`,
		method: 'GET',
		data
	});
}
...
export const myForum = (page = 1, limit = 10) => {
	...
	return http.request({
		url: `forum/page?parentid=0&sort=istop,toptime&order=desc,desc`,
		method: 'GET',
		data
	});
}
...
export const mlist = (tableName, data) => {
	return http.request({
		url: `${tableName}/mlist`,
		method: 'GET',
		data
...
export const page2 = (tableName, data) => {
	return http.request({
		url: `${tableName}/page2`,
		method: 'GET',
		data
...
export const getPublic = (url,data) => {
	return http.request({
		url: `${url}`,
		method: 'GET',
		data
