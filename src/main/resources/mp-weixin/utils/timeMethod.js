 ...
 * 时间戳转时间
 */
exports.timestampToTime = function(timestamp, type) {
 ...
 * 时间转时间戳
 */
exports.timeToTimestamp = function(time) {
 ...
 * 日期计算
 */
exports.calculateTime = function(startTime, endTime) {
 ...
 * 日期转星期
 */
exports.getDateToWeek = function(time) {
  let weekArrayList = [{
      "weekID": 7,
      "weekName": "星期日"
    },
 ...
 */
exports.timeFormat = function(date, type) {
  if (type == "T")
 ...
 * 定时器
 */
exports.timeSleep = function(time) {
 ...
 * @param dayCount
 */
exports.countDateStr = function(dayCount) {
  let dd = new Date();
 ...
 * 日期中时间置0
 */
exports.setTimeZero = function(time) {
