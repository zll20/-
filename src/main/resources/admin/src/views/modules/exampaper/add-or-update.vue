		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="试卷名称" prop="name" >
					<el-input v-model="ruleForm.name" placeholder="试卷名称" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="试卷名称" prop="name" >
					<el-input v-model="ruleForm.name" placeholder="试卷名称" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="考试时长(分钟)" prop="time" >
					<el-input v-model.number="ruleForm.time" placeholder="考试时长(分钟)" clearable  :readonly="ro.time"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="考试时长(分钟)" prop="time" >
					<el-input v-model="ruleForm.time" placeholder="考试时长(分钟)" readonly></el-input>
				</el-form-item>
				<el-form-item class="select" v-if="type!='info'"  label="试卷状态" prop="status" >
					<el-select :disabled="ro.status" v-model="ruleForm.status" placeholder="请选择试卷状态"  filterable>
						<el-option
				...
				<el-form-item v-else class="input" label="试卷状态" prop="status" >
					<el-input v-model="ruleForm.status?'启用':'禁用'" 
						placeholder="试卷状态" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="限考次数" prop="examnum" >
					<el-input v-model.number="ruleForm.examnum" placeholder="限考次数" clearable  :readonly="ro.examnum"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="限考次数" prop="examnum" >
					<el-input v-model="ruleForm.examnum" placeholder="限考次数" readonly></el-input>
				</el-form-item>
			</template>
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='examnum'){
							this.ruleForm.examnum = obj[o];
							this.ro.examnum = true;
							continue;
						}
					}
					this.ruleForm.examnum = Number('1'); 				}
