<template>
	<div class="addEdit-block">
		<el-form
			...
			label-width="140px"
		>
			<el-form-item label="选择试卷名称" prop="paperid">
				<el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择试卷名称">
					<el-option
	...
	export default {
		data() {
			...
			return {
				...
				rules: {
					paperid: [{ required: true, message: "请选择试卷名称", trigger: "blur" }],
					questionname: [
