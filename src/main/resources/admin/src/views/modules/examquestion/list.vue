		...
		<template v-if="!showFlag">
			<el-form :style='{"width":"100%","padding":"0","margin":"0 0 30px 0","fontSize":"inherit","borderRadius":"8px","background":"non"}' :inline="true" :model="searchForm" class="center-form-pv">
				...
				<el-row class="actions" :style='{"width":"calc(100% + 8px)","padding":"0px","margin":"0px 0 0px -4px","flexWrap":"wrap","justifyContent":"0","display":"flex"}'>
					<el-button v-if="isAuth('examquestion','新增')" class="add" :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"4px","outline":"none","color":"#FA6B04","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"36px"}' type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia17" :style='{"margin":"0 0px","fontSize":"16px","color":"#FA6B04","height":"auto"}'></span>
						添加
					</el-button>
					<el-button v-if="isAuth('examquestion','删除')" class="del" :disabled="dataListSelections.length <= 0" :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"4px","outline":"none","color":"#FA6B04","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"36px"}' type="danger" @click="deleteHandler()">
			...
			<div :style='{"width":"100%","padding":"20px ","borderRadius":"8px","background":"#fff","borderWidth":"0"}'>
				...
				>
					...
					>
						<template slot-scope="scope">
							<el-button v-if="isAuth('examquestion','修改')" class="edit" :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","outline":"none","color":"#FA6B04","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"32px","order":"3"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
							...
							<el-button v-if="isAuth('examquestion','删除')" class="del" :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","outline":"none","color":"#FA6B04","borderRadius":"6px","background":"none","width":"auto","fontSize":"14px","height":"32px","order":"3"}' type="primary" @click="deleteHandler(scope.row.id)">
