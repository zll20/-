<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 140px","margin":"0","position":"relative","background":"#fafafe","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0 0 0 250px","position":"relative","background":"url(http://codegen.caihongy.cn/20250826/9c566af26d2e4baca85799a2893fb657.png) no-repeat center top / cover","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"border":"0","padding":"0","margin":"0 auto","alignItems":"center","color":"#E56B00","display":"flex","justifyContent":"center","borderRadius":"0 0 30px 30px","background":"none","borderWidth":"0px 1px 1px","width":"calc(100% - 60px)","position":"relative","zIndex":"1","height":"80px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"8px 10px","margin":"15px auto 0 auto","borderColor":"#e7e8fc","borderWidth":"0px","background":"none","display":"none","width":"calc(100% - 60px)","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
