...
public class DancixuexiController {
    ...
    public R page(@RequestParam Map<String, Object> params,DancixuexiEntity dancixuexi,
        ...
        QueryWrapper<DancixuexiEntity> ew = new QueryWrapper<DancixuexiEntity>();
    ...
    public R info(@PathVariable("id") Long id){
        DancixuexiEntity dancixuexi = dancixuexiService.getById(id);
        Map<String, String> deSens = new HashMap<>();
        DeSensUtil.desensitize(dancixuexi,deSens);
    ...
    public R save(@RequestBody DancixuexiEntity dancixuexi, HttpServletRequest request){
        dancixuexiService.save(dancixuexi);
        return R.ok().put("data",dancixuexi.getId());
    }
    ...
    public R update(@RequestBody DancixuexiEntity dancixuexi, HttpServletRequest request){
        dancixuexiService.updateById(dancixuexi);
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        dancixuexiService.removeBatchByIds(Arrays.asList(ids));
        return R.ok();
    }
