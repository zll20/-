...
public class BaiduUtil {
    ...
    public static String generalString(String imagePath, boolean isNewline){
        try{
            ...
            //通用文字识别
            if(ocrClient==null) {
                ocrClient = new AipOcr(ConfigUtil.getConfigValue("baidu","appId"), ConfigUtil.getConfigValue("baidu","apiKey"), ConfigUtil.getConfigValue("baidu","secretKey"));
    ...
    public static JSONObject animalDetect(String imgPath) {
        //初始化
        AipImageClassify aic = new AipImageClassify(ConfigUtil.getConfigValue("baidu","appId"), ConfigUtil.getConfigValue("baidu","apiKey"), ConfigUtil.getConfigValue("baidu","secretKey"));
        //返回JSON格式的数据
    ...
    public static JSONObject bodyNum(String imgPath) {
        //初始化
        AipBodyAnalysis aba = new AipBodyAnalysis(ConfigUtil.getConfigValue("baidu","appId"), ConfigUtil.getConfigValue("baidu","apiKey"), ConfigUtil.getConfigValue("baidu","secretKey"));
        //返回JSON格式的数据
        HashMap<String, String> params = new HashMap<String, String>();
    ...
    public static JSONObject asr(String wavPath) {
        //初始化
        AipSpeech as = new AipSpeech(ConfigUtil.getConfigValue("baidu","appId"), ConfigUtil.getConfigValue("baidu","apiKey"), ConfigUtil.getConfigValue("baidu","secretKey"));
        //返回JSON格式的数据
    ...
    public static JSONObject textTrans(String from, String to, String q) {
        //初始化
        AipTranslate as = new AipTranslate(ConfigUtil.getConfigValue("baidu","appId"), ConfigUtil.getConfigValue("baidu","apiKey"), ConfigUtil.getConfigValue("baidu","secretKey"));
        //返回JSON格式的数据
    ...
    public static JSONObject picTrans(String from, String to, File image) {
        //初始化
        AipPicTrans aic = new AipPicTrans(ConfigUtil.getConfigValue("baidu","appId"), ConfigUtil.getConfigValue("baidu","apiKey"), ConfigUtil.getConfigValue("baidu","secretKey"));
        //返回JSON格式的数据
    ...
    public static Map<String, Object> sentimentClassify(String text) {
        ...
        // 初始化一个AipNlp
        AipNlp client = new AipNlp(ConfigUtil.getConfigValue("baidu","appId"), ConfigUtil.getConfigValue("baidu","apiKey"), ConfigUtil.getConfigValue("baidu","secretKey"));
        // 调用情感分析接口
